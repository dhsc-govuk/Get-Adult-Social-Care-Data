      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          <h1 className="govuk-heading-l">
            Indicator definition and supporting information: adult social care
            ...
            <thead className="govuk-table__head">
              <tr className="govuk-table__row">
                ...
                <td className="govuk-table__cell">
                  ...
                  providers across health and adult social care, adjusted to a
                  rate of 100,000 adults (aged 18 and over) in the local
                  authority, regional or national population, published by
              ...
              <tr className="govuk-table__row">
                ...
                <td className="govuk-table__cell">
                  <p className="govuk-body">
                    This indicator counts all beds reported by care providers
                    that are related to adult social care, including the
