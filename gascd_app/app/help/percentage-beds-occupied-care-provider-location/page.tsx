			...
			<div className="govuk-grid-row">
				<div className="govuk-grid-column-two-thirds">
					<h1 className="govuk-heading-l">
						Indicator definition and supporting information: percentage of adult social care beds occupied in care
						provider location
					</h1>
					...
					<table className="govuk-table">
						<thead className="govuk-table__head">
							<tr className="govuk-table__row">
								...
								<td className="govuk-table__cell">
									The percentage of adult social care beds reported as currently occupied in a specific care provider
									location.
								</td>
							</tr>
						</thead>
						<tbody className="govuk-table__body">
							...
							<tr className="govuk-table__row">
								...
								<td className="govuk-table__cell">
									<p className="govuk-body">The occupancy rate is calculated by dividing the number of occupied beds by the total number of beds 
									in each location.</p>
									<p className="govuk-body">
									The data reflects the number of beds recorded by care providers. 'Beds' refers to adult social care beds 
									in care providers registered with the Care Quality Commission (CQC) and includes the following categories:
									</p>
									<br></br>
									...
									<p className="govuk-body">
									'Occupied beds' refers to beds reported as being in use at the time of data collection within 
									the specified location.
									</p>
									<p className="govuk-body">
									Care providers registered with the CQC must update this information at least monthly using 
									the Capacity Tracker tool. The mandated reporting period is between the 8th and 14th every month, 
									or the next working day if the 14th falls on a weekend or holiday.
									</p>
									</td>
							</tr>
						</tbody>
