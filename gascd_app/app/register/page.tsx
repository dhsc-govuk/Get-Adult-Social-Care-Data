      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          ...
          <p className="govuk-body-m">
            ...
            access to a wide range of datasets relevant to adult social care in
            England.
          </p>
          ...
          <ul className="govuk-list govuk-list--bullet">
            <li>
              access data and track indicators, across themes including demand,
              capacity, service quality, care outcomes, workforce, and market
              sustainability{' '}
            </li>
            <li>
              explore and visualise data with interactive tools that help you to
          ...
          <p className="govuk-body-m">
            Access is subject to approval by the Department of Health and Social
            Care (DHSC).
          </p>
          ...
          <p className="govuk-body-m">
            DHSC will normally contact you within x working days to grant access
            or ask for more information. During busy periods, this may take
            longer.
          </p>
          ...
          <p className="govuk-body-m">
            Once you&apos;re approved, you can sign in to Get adult social care
            data.
          </p>

          <p className="govuk-body-m">
            When you sign in for the first time, you&apos;ll be asked to create
