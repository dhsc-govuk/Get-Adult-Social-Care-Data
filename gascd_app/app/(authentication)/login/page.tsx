      ...
      >
        <div className="govuk-grid-row">
          <div className="govuk-grid-column-two-thirds">
            ...
            <p className="govuk-body">
              Please note that this service provides information only and does not constitute advice. DHSC does not accept any liability for decisions made by providers following use of this service. 
              Further details are in the <a href="/disclaimer" className="govuk-link" rel="noreferrer noopener" target="_blank">Full Disclaimer (opens in new tab)</a>.
            </p>            
            <h2 className="govuk-heading-m">
              Beta phase testing
            </h2>
