          ...
          source={
            <>
              <Link
                ...
                target="_blank"
              >
                Fingertips from the Department of Health and Social Care (opens
                in new tab)
              </Link>
            </>
          }
          ...
          methodology={
            <>
              <p>
                ...
                that age group who are likely to have dementia, based on
                national prevalence rates. The estimates use population data and
                standard prevalence models to provide an expected number of
                cases.
              </p>
            </>
          }
          limitations={
            <>
              <p>
                ...
                Isles of Scilly. All counts are greater than 300, except for
                City of London and Isles of Scilly. Both of these have indicator
                values close to 50 percent so the normal approximation is still
