...
class ElementError extends GOVUKFrontendError {
  constructor(t) {
    ...
    if (isObject(t)) {
      ...
      ((e = s),
        (e += n
          ? ` is not of type ${null != i ? i : 'HTMLElement'}`
          : ' not found'),
        o && (e = formatErrorMessage(o, e)));
    }
  ...
  constructor(e, o) {
    ...
    const n = (function (t, e) {
      ...
      for (const n of s) {
        const [s, i] = n,
          r = s.toString();
        (r in e && (o[r] = normaliseString(e[r], i)),
          'object' === (null == i ? void 0 : i.type) &&
            (o[r] = extractConfigByNamespace(t.schema, e, s)));
      }
      return o;
...
function normaliseString(t, e) {
  ...
  switch (
    (n ||
      (['true', 'false'].includes(o) && (n = 'boolean'),
      o.length > 0 && isFinite(Number(o)) && (n = 'number')),
    n)
  ) {
    case 'boolean':
      s = 'true' === o;
...
function extractConfigByNamespace(t, e, o) {
  ...
  for (const [i, r] of Object.entries(e)) {
    ...
    for (const [s, n] of e.entries())
      isObject(t) &&
        (s < e.length - 1
          ? (isObject(t[n]) || (t[n] = {}), (t = t[n]))
          : i !== o && (t[n] = normaliseString(r)));
  }
  return n[o];
}
function createAll(t, e, o) {
  ...
  const n = (function (t) {
    ...
    if (isObject(t)) {
      const s = t;
      ((isScope(s.scope) || null === s.scope) && (o = s.scope),
        'function' == typeof s.onError && (e = s.onError));
    }
    return (
      isScope(t)
        ? (o = t)
  ...
  try {
    ...
    s =
      null == (i = n.scope)
        ? void 0
        : i.querySelectorAll(`[data-module="${t.moduleName}"]`);
  } catch (r) {
    return (
      n.onError ? n.onError(r, { component: t, config: e }) : console.log(r),
      []
    );
  }
  return Array.from(null != s ? s : [])
    .map((o) => {
      try {
        ...
        return (
          n.onError
            ? n.onError(r, { element: o, component: t, config: e })
            : console.log(r),
          null
        );
      }
...
class AddAnother extends Component {
  ...
  onAddButtonClick(t) {
    ...
    if (
      !(
        ...
        e.classList.contains('moj-add-another__add-button')
      )
    )
      return;
  ...
  updateAttributes(t, e) {
    t.querySelectorAll('[data-name]').forEach((o) => {
      if (!this.isValidInputElement(o)) return;
      const s = o.getAttribute('data-name') || '',
        n = o.getAttribute('data-id') || '',
        i = o.id;
      ((o.name = s.replace(/%index%/, `${e}`)),
        (o.id = n.replace(/%index%/, `${e}`)));
      const r =
        o.parentElement.querySelector('label') ||
        o.closest('label') ||
  ...
  resetItem(t) {
    t.querySelectorAll('[data-name], [data-id]').forEach((t) => {
      if (this.isValidInputElement(t))
        ...
        else if (t instanceof HTMLTextAreaElement) t.value = '';
        else
          switch (t.type) {
            case 'checkbox':
            case 'radio':
  ...
  onRemoveButtonClick(t) {
    ...
    if (
      !(
        e &&
        e instanceof HTMLButtonElement &&
        e.classList.contains('moj-add-another__remove-button')
      )
    )
      return;
    ...
    const o = this.getItems();
    (1 === o.length &&
      o[0].querySelector('.moj-add-another__remove-button').remove(),
      o.forEach((t, e) => {
...
function setFocus(t, e = {}) {
  ...
  (s || t.setAttribute('tabindex', '-1'),
    ...
    null == (o = e.onBeforeFocus) || o.call(t),
    t.focus());
}
      ...
      this.config.dismissible &&
        ...
        this.$root.addEventListener('click', (t) => {
          t.target instanceof Node &&
            this.$dismissButton.contains(t.target) &&
            this.dimiss();
        })));
  }
  dimiss() {
    ...
    if (
      (this.config.focusOnDismissSelector &&
        (t = document.querySelector(this.config.focusOnDismissSelector)),
      !t)
    ) {
    ...
    (t ||
      ...
      })(this.$root, '.moj-alert, h1, h2, h3, h4, h5, h6')),
      t ||
        (t = (function (t, e) {
        ...
        })(this.$root, 'h1, h2, h3, h4, h5, h6, main, body')),
      t instanceof HTMLElement && setFocus(t),
      this.$root.remove());
  }
}
...
class ButtonMenu extends ConfigurableComponent {
    ...
    if ((super(t, e), 1 === this.$root.children.length)) {
      ...
      (t.classList.forEach((e) => {
        (e.startsWith('govuk-button-') && t.classList.remove(e),
          t.classList.remove('moj-button-menu__item'),
          t.classList.add('moj-button-menu__single-button'));
      }),
        this.config.buttonClasses &&
          t.classList.add(...this.config.buttonClasses.split(' ')));
    }
  ...
  createMenu() {
    ...
    for (
      t.setAttribute('role', 'list'),
        ...
        'right' === this.config.alignMenu &&
          t.classList.add('moj-button-menu__wrapper--right'),
  ...
  openMenu(t = 0) {
    ((this.$menu.hidden = !1),
      ...
      -1 !== t && this.focusItem(t));
  }
  closeMenu(t = !0) {
    ((this.$menu.hidden = !0),
      this.$menuToggle.setAttribute('aria-expanded', 'false'),
      t && this.$menuToggle.focus());
  }
  focusItem(t) {
  ...
  currentFocusIndex() {
    const t = document.activeElement,
      e = Array.from(this.$items);
    return (
      (t instanceof HTMLAnchorElement || t instanceof HTMLButtonElement) &&
      e.indexOf(t)
    );
  }
  handleKeyDown(t) {
    ...
    ('Escape' === t.key && this.isOpen() && this.closeMenu(),
      'Tab' === t.key && this.isOpen() && this.closeMenu(!1));
  }
}
...
class DatePicker extends ConfigurableComponent {
  constructor(t, e = {}) {
    ...
    super(t, e);
    const s =
      null != (o = this.config.input.element)
        ? o
        : this.$root.querySelector(this.config.input.selector);
    if (!(s && s instanceof HTMLInputElement)) return this;
    ((this.$input = s),
      (this.dayLabels = [
        'Monday',
        'Tuesday',
  ...
  initControls() {
    ...
    (t.classList.add('moj-datepicker__wrapper'),
      ...
      (this.$cancelButton = this.$dialog.querySelector(
        '.moj-js-datepicker-cancel'
      )),
      (this.$okButton = this.$dialog.querySelector('.moj-js-datepicker-ok')),
      this.$prevMonthButton.addEventListener('click', (t) =>
        this.focusPreviousMonth(t, !1)
      ),
      this.$prevYearButton.addEventListener('click', (t) =>
        this.focusPreviousYear(t, !1)
      ),
      this.$nextMonthButton.addEventListener('click', (t) =>
        this.focusNextMonth(t, !1)
      ),
      this.$nextYearButton.addEventListener('click', (t) =>
        this.focusNextYear(t, !1)
      ),
    ...
    ((this.$firstButtonInDialog = o[0]),
      (this.$lastButtonInDialog = o[o.length - 1]),
      this.$firstButtonInDialog.addEventListener('keydown', (t) =>
        this.firstButtonKeydown(t)
      ),
      this.$lastButtonInDialog.addEventListener('keydown', (t) =>
        this.lastButtonKeydown(t)
      ),
      this.$calendarButton.addEventListener('click', (t) =>
        this.toggleDialog(t)
      ),
      ...
      document.body.addEventListener('mouseup', (t) => {
        this.backgroundClick(t);
      }),
      this.updateCalendar());
  }
  createDialog() {
  ...
  createCalendar() {
    ...
    for (let o = 0; o < 6; o++) {
      ...
      for (let t = 0; t < 7; t++) {
        ...
        (i.setAttribute('type', 'button'), n.appendChild(i));
  ...
  setExcludedDates() {
    this.config.excludedDates &&
      (this.excludedDates = this.config.excludedDates
        ...
        .map((t) =>
          t.includes('-')
            ? this.parseDateRangeString(t)
            : [this.formattedDateFromString(t)]
        )
  ...
  parseDateRangeString(t) {
    const e = [],
      [o, s] = t.split('-').map((t) => this.formattedDateFromString(t, null));
    if (o && s) {
      const t = new Date(o.getTime());
      for (; t <= s; ) (e.push(new Date(t)), t.setDate(t.getDate() + 1));
    }
    return e;
  }
  setExcludedDays() {
    if (this.config.excludedDays) {
      ...
      ('monday' === this.config.weekStartDay && t.unshift(t.pop()),
  ...
  isExcludedDate(t) {
    ...
    for (const e of this.excludedDates)
      if (t.toDateString() === e.toDateString()) return !0;
  ...
  formattedDateFromString(t, e = new Date()) {
    ...
    const n = s.exec(t),
      ...
      a = n[4];
    return (
      (o = new Date(Number(a), Number(r) - 1, Number(i))),
      o instanceof Date && Number.isFinite(o.getTime()) ? o : e
    );
  }
  ...
  updateCalendar() {
    ...
    let o;
    ((o =
      'monday' === this.config.weekStartDay
        ? 0 === e.getDay()
          ? 6
          : e.getDay() - 1
        : e.getDay()),
    ...
    for (const n of this.calendarDays) {
      const e = s.getMonth() !== t.getMonth(),
        o = this.isExcludedDate(s);
  ...
  setCurrentDate(t = !0) {
    ...
    if (
      (this.calendarDays.forEach((o) => {
        (o.$button.classList.add('moj-datepicker__button'),
          o.$button.classList.add('moj-datepicker__calendar-day'),
          o.$button.setAttribute('tabindex', '-1'),
          o.$button.classList.remove(this.selectedDayButtonClass));
        const s = o.date;
        s.setHours(0, 0, 0, 0);
        const n = new Date();
        (n.setHours(0, 0, 0, 0),
          s.getTime() === e.getTime() &&
            t &&
            (o.$button.setAttribute('tabindex', '0'),
            o.$button.focus(),
            o.$button.classList.add(this.selectedDayButtonClass)),
          this.inputDate && s.getTime() === this.inputDate.getTime()
            ? (o.$button.classList.add(this.currentDayButtonClass),
              o.$button.setAttribute('aria-current', 'date'))
            : (o.$button.classList.remove(this.currentDayButtonClass),
      ...
      const t = this.calendarDays.filter(
        (t) =>
          'block' === window.getComputedStyle(t.$button).display &&
          !t.$button.disabled
      );
      (t[0].$button.setAttribute('tabindex', '0'),
        (this.currentDate = t[0].date));
    }
  }
  selectDate(t) {
    if (this.isExcludedDate(t)) return;
    ((this.$calendarButton.querySelector('span').innerText =
      `Choose date. Selected date is ${this.formattedDateHuman(t)}`),
  ...
  openDialog() {
    ((this.$dialog.hidden = !1),
      ...
      this.minDate &&
        ...
        console.error(
          'min date is after max date. No dates will be selectable'
        ),
  ...
  goToDate(t, e) {
    ...
    ((this.currentDate = t),
      (o.getMonth() === this.currentDate.getMonth() &&
  ...
  focusFirstDayOfWeek() {
    const t = new Date(this.currentDate),
      e = 'sunday' === this.config.weekStartDay ? 0 : 1,
      o = t.getDay(),
      s = o >= e ? o - e : 6 - o;
  ...
  focusLastDayOfWeek() {
    const t = new Date(this.currentDate),
      e = 'sunday' === this.config.weekStartDay ? 6 : 0,
      o = t.getDay(),
      s = o <= e ? e - o : 7 - o;
    (t.setDate(t.getDate() + s), t.setHours(0, 0, 0, 0), this.goToDate(t));
  }
...
class DSCalendarDay {
  ...
  update(t, e, o) {
    ...
    (o
      ...
      this.$button.setAttribute(
        'data-testid',
        this.picker.formattedDateFromDate(t)
      ),
      (this.$button.innerHTML = `<span class="govuk-visually-hidden">${n}</span><span aria-hidden="true">${s}</span>`),
  ...
  keyPress(t) {
    ...
    switch (t.key) {
      ...
      case 'PageUp':
        t.shiftKey
          ? this.picker.focusPreviousYear(t)
          : this.picker.focusPreviousMonth(t);
        break;
      case 'PageDown':
        t.shiftKey
          ? this.picker.focusNextYear(t)
          : this.picker.focusNextMonth(t);
        break;
      default:
        e = !1;
    }
...
class PdsHeader extends Component {
  ...
  initHeader() {
    ...
    const t = this.$root.querySelector(
      ...
      e = this.$root.querySelector('#probation-common-header-user-menu'),
      o = this.$root.querySelector(
        '.probation-common-header__services-menu-toggle'
      ),
      s = this.$root.querySelector('#probation-common-header-services-menu');
    if (
      !(
        t &&
        e &&
    ...
    (this.hideFallbackLinks(),
      ...
      t.addEventListener('click', (n) => {
        (this.closeTabs([[o, s]]), this.toggleMenu(t, e));
      }),
      o.addEventListener('click', (n) => {
        (this.closeTabs([[t, e]]), this.toggleMenu(o, s));
      }));
  }
  closeTabs(t) {
    t.forEach(([t, e]) => {
      e &&
        ...
        t.classList.remove(this.$tabOpenClass),
        t.parentElement.classList.remove('item-open'),
        t.setAttribute('aria-expanded', 'false'),
        t.dataset.textForShow &&
          t.setAttribute('aria-label', t.dataset.textForShow));
    });
  }
  toggleMenu(t, e) {
    !e.getAttribute('hidden')
      ...
      : e &&
        ...
        t.classList.add(this.$tabOpenClass),
        t.parentElement.classList.add('item-open'),
        t.setAttribute('aria-expanded', 'true'),
        t.dataset.textForHide &&
          t.setAttribute('aria-label', t.dataset.textForHide));
  }
  hideFallbackLinks() {
    const t = this.$root.querySelector(
...
class FilterToggleButton extends ConfigurableComponent {
  constructor(t, e = {}) {
    ...
    super(t, e);
    const n =
        null != (o = this.config.toggleButtonContainer.element)
          ? o
          : document.querySelector(this.config.toggleButtonContainer.selector),
      i =
        null != (s = this.config.closeButtonContainer.element)
          ? s
          : this.$root.querySelector(this.config.closeButtonContainer.selector);
    if (!(n instanceof HTMLElement && i instanceof HTMLElement)) return this;
    ((this.$toggleButtonContainer = n),
      (this.$closeButtonContainer = i),
      this.createToggleButton(),
      this.setupResponsiveChecks(),
      this.$root.setAttribute('tabindex', '-1'),
      this.config.startHidden && this.hideMenu());
  }
  ...
  removeCloseButton() {
    this.$closeButton &&
      (this.$closeButton.remove(), (this.$closeButton = null));
  }
  hideMenu() {
    (this.$menuButton.setAttribute('aria-expanded', 'false'),
...
class FormValidator extends ConfigurableComponent {
  constructor(t, e = {}) {
    ...
    if (!(o && o instanceof HTMLElement)) return this;
    ((this.$summary = o),
      (this.errors = []),
      (this.validators = []),
  ...
  getSummaryHtml() {
    ...
    for (const e of this.errors)
      ((t += '<li>'),
        (t += `<a href="#${this.escapeHtml(e.fieldName)}">`),
        (t += this.escapeHtml(e.message)),
        (t += '</a>'),
        (t += '</li>'));
    return ((t += '</ul>'), (t += '</div>'), t);
  }
  ...
  showInlineErrors() {
    for (const t of this.errors) this.showInlineError(t);
  }
  showInlineError(t) {
    const e = document.createElement('span');
    ((e.id = `${t.fieldName}-error`),
      e.classList.add('govuk-error-message'),
      (e.innerHTML = this.escapeHtml(t.message)));
    const o = document.querySelector(`#${t.fieldName}`),
      s = o.closest('.govuk-fieldset'),
      n = (s || o).closest('.govuk-form-group'),
      i = n.querySelector('label'),
      r = n.querySelector('legend');
    (n.classList.add('govuk-form-group--error'),
      s && r
        ? (r.after(e),
          n.setAttribute('aria-invalid', 'true'),
          addAttributeValue(s, 'aria-describedby', e.id))
        : i &&
          o &&
          (i.after(e),
          o.setAttribute('aria-invalid', 'true'),
          addAttributeValue(o, 'aria-describedby', e.id)));
  }
  removeInlineErrors() {
    for (const t of this.errors) this.removeInlineError(t);
  }
  removeInlineError(t) {
    const e = document.querySelector(`#${t.fieldName}-error`),
      ...
      r = n.querySelector('legend');
    (e.remove(),
      n.classList.remove('govuk-form-group--error'),
      s && r
        ? (n.removeAttribute('aria-invalid'),
          removeAttributeValue(s, 'aria-describedby', e.id))
        : i &&
          o &&
          (o.removeAttribute('aria-invalid'),
          removeAttributeValue(o, 'aria-describedby', e.id)));
  }
  addValidator(t, e) {
    this.validators.push({
      fieldName: t,
      rules: e,
      field: this.$root.elements.namedItem(t),
    });
  }
  validate() {
    this.errors = [];
    ...
    for (t = 0; t < this.validators.length; t++)
      for (o = this.validators[t], e = 0; e < o.rules.length; e++) {
        if (
          ((s = o.rules[e].method(o.field, o.rules[e].params)),
          'boolean' == typeof s && !s)
        ) {
          this.errors.push({
...
((FormValidator.entityMap = {
  ...
  (FormValidator.defaults = Object.freeze({
    summary: { selector: '.govuk-error-summary' },
  })),
...
class MultiFileUpload extends ConfigurableComponent {
  constructor(t, e = {}) {
    var o;
    if ((super(t, e), !MultiFileUpload.isSupported())) return this;
    const s =
      null != (o = this.config.feedbackContainer.element)
        ? o
        : this.$root.querySelector(this.config.feedbackContainer.selector);
    if (!(s && s instanceof HTMLElement)) return this;
    ((this.$feedbackContainer = s),
      this.setupFileInput(),
      this.setupDropzone(),
      this.setupLabel(),
      this.setupStatusBox(),
  ...
  setupLabel() {
    ...
    (t.setAttribute('for', this.$fileInput.id),
      t.classList.add('govuk-button', 'govuk-button--secondary'),
      (t.textContent = this.config.dropzoneButtonText));
    const e = document.createElement('p');
    (e.classList.add('govuk-body'),
      (e.textContent = this.config.dropzoneHintText),
      (this.$label = t),
      this.$dropzone.append(e),
      this.$dropzone.append(t));
  }
  setupFileInput() {
  ...
  onDrop(t) {
    (t.preventDefault(),
      ...
      this.uploadFiles(t.dataTransfer.files));
  }
  uploadFiles(t) {
    for (const e of Array.from(t)) this.uploadFile(e);
  }
  onFileChange() {
    (this.$feedbackContainer.classList.remove('moj-hidden'),
      (this.$status.textContent = this.config.uploadStatusText),
  ...
  getFileRow(t) {
    ...
    return (
      e.classList.add('govuk-summary-list__row', 'moj-multi-file-upload__row'),
  ...
  getDeleteButton(t) {
    ...
    return (
      ...
      e.setAttribute('name', 'delete'),
      e.setAttribute('value', t.filename),
      e.classList.add(
      ...
      (e.innerHTML = `Delete <span class="govuk-visually-hidden">${t.originalname}</span>`),
      e
    );
  }
  uploadFile(t) {
    ...
    const r = new XMLHttpRequest(),
      onError = () => {
        const e = new Error(
          r.response && 'error' in r.response
            ? r.response.error.message
            : r.statusText || 'Upload failed'
        );
        ((o.innerHTML = this.getErrorHtml(e)),
          (this.$status.textContent = e.message),
          this.config.hooks.errorHook(this, t, r, r.statusText, e));
      };
    (r.addEventListener('load', () => {
      if (r.status < 200 || r.status >= 300 || !('success' in r.response))
        return onError();
      ((o.innerHTML = this.getSuccessHtml(r.response.success)),
        (this.$status.textContent = r.response.success.messageText),
        s.append(this.getDeleteButton(r.response.file)),
        this.config.hooks.exitHook(this, t, r, r.statusText));
    }),
      ...
      r.open('POST', this.config.uploadUrl),
      (r.responseType = 'json'),
      r.send(i));
  }
  onFileDeleteClick(t) {
    ...
    if (
      !(
        e &&
        e instanceof HTMLButtonElement &&
        e.classList.contains('moj-multi-file-upload__delete')
      )
    )
      return;
    t.preventDefault();
    ...
    (o.addEventListener('load', () => {
      ...
      (s && s.remove(),
        this.config.hooks.deleteHook(this, void 0, o, o.statusText));
    }),
      o.open('POST', this.config.deleteUrl),
      o.setRequestHeader('Content-Type', 'application/json'),
      (o.responseType = 'json'),
      o.send(JSON.stringify({ [e.name]: e.value })));
  }
  static isSupported() {
    return (
...
class MultiSelect extends ConfigurableComponent {
  constructor(t, e = {}) {
    ...
    const s = this.$root.querySelector(`#${this.config.idPrefix}select-all`),
      n =
        null != (o = this.config.checkboxes.items)
          ? o
          : this.$root.querySelectorAll(this.config.checkboxes.selector);
    if (!(s && s instanceof HTMLElement && n.length)) return this;
    (this.setupToggle(this.config.idPrefix),
      ...
      (this.$checkboxes = Array.from(n)),
      this.$checkboxes.forEach((t) =>
        t.addEventListener('click', this.onCheckboxClick.bind(this))
      ),
      (this.checked = e.checked || !1));
  }
  setupToggle(t = '') {
    const e = `${t}checkboxes-all`,
    ...
    (o.classList.add(
      ...
      (n.id = e),
      (n.type = 'checkbox'),
      n.classList.add('govuk-checkboxes__input'),
      ...
      i.classList.add('govuk-visually-hidden'),
      (i.textContent = 'Select all'),
      s.append(i),
      o.append(n, s),
      (this.$toggle = o));
  }
  onButtonClick() {
    this.checked
      ? (this.uncheckAll(), (this.$toggleButton.checked = !1))
...
class PasswordReveal extends Component {
  constructor(t) {
    ...
    if (!(e && e instanceof HTMLInputElement)) return this;
    ((this.$input = e),
...
class RichTextEditor extends ConfigurableComponent {
  constructor(t, e = {}) {
    if ((super(t, e), !RichTextEditor.isSupported())) return this;
    const o = this.$root.querySelector('.govuk-textarea');
    if (!(o && o instanceof HTMLTextAreaElement)) return this;
    ((this.$textarea = o),
      this.createToolbar(),
      this.hideDefault(),
  ...
  onToolbarKeydown(t) {
    ...
    switch (t.keyCode) {
      ...
      case this.keys.down:
        if (
          ((e = this.$buttons.find((t) => '0' === t.getAttribute('tabindex'))),
          e)
        ) {
  ...
  onButtonClick(t) {
    t.currentTarget instanceof HTMLElement &&
      document.execCommand(
        t.currentTarget.getAttribute('data-command'),
        !1,
        void 0
      );
  }
...
((RichTextEditor.moduleName = 'moj-rich-text-editor'),
  (RichTextEditor.defaults = Object.freeze({
    toolbar: { bold: !1, italic: !1, underline: !1, bullets: !0, numbers: !0 },
  })),
...
class SearchToggle extends ConfigurableComponent {
  constructor(t, e = {}) {
    ...
    super(t, e);
    const n =
        null != (o = this.config.searchContainer.element)
          ? o
          : this.$root.querySelector(this.config.searchContainer.selector),
      i =
        null != (s = this.config.toggleButtonContainer.element)
          ? s
          : this.$root.querySelector(
              this.config.toggleButtonContainer.selector
            );
    if (!(n && i && n instanceof HTMLElement && i instanceof HTMLElement))
      return this;
    ...
    ((this.$toggleButton = document.createElement('button')),
      ...
      (this.$toggleButton.innerHTML = `${this.config.toggleButton.text} <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="moj-search-toggle__button__icon"><path d="M7.433,12.5790048 C6.06762625,12.5808611 4.75763941,12.0392925 3.79217348,11.0738265 C2.82670755,10.1083606 2.28513891,8.79837375 2.28699522,7.433 C2.28513891,6.06762625 2.82670755,4.75763941 3.79217348,3.79217348 C4.75763941,2.82670755 6.06762625,2.28513891 7.433,2.28699522 C8.79837375,2.28513891 10.1083606,2.82670755 11.0738265,3.79217348 C12.0392925,4.75763941 12.5808611,6.06762625 12.5790048,7.433 C12.5808611,8.79837375 12.0392925,10.1083606 11.0738265,11.0738265 C10.1083606,12.0392925 8.79837375,12.5808611 7.433,12.5790048 L7.433,12.5790048 Z M14.293,12.579 L13.391,12.579 L13.071,12.269 C14.2300759,10.9245158 14.8671539,9.20813198 14.866,7.433 C14.866,3.32786745 11.5381325,-1.65045755e-15 7.433,-1.65045755e-15 C3.32786745,-1.65045755e-15 -1.65045755e-15,3.32786745 -1.65045755e-15,7.433 C-1.65045755e-15,11.5381325 3.32786745,14.866 7.433,14.866 C9.208604,14.8671159 10.9253982,14.2296624 12.27,13.07 L12.579,13.39 L12.579,14.294 L18.296,20 L20,18.296 L14.294,12.579 L14.293,12.579 Z"></path></svg>`),
      this.$toggleButton.addEventListener(
        'click',
  ...
  onDocumentClick(t) {
    t.target instanceof Node &&
      !this.$toggleButtonContainer.contains(t.target) &&
      !this.$searchContainer.contains(t.target) &&
      this.hideMenu();
  }
}
...
class SortableTable extends ConfigurableComponent {
  ...
  createHeadingButtons() {
    for (const t of this.$headings)
      t.hasAttribute('aria-sort') && this.createHeadingButton(t);
  }
  createHeadingButton(t) {
    const e = this.$headings.indexOf(t),
  ...
  initialiseSortedColumn() {
    var t;
    const e = this.getTableRowsArray(),
      o = this.$root.querySelector(
      ...
      i = Number.parseInt(
        null != (t = null == s ? void 0 : s.getAttribute('data-index'))
          ? t
          : '0',
        10
      );
    if (!o || !s || ('ascending' !== n && 'descending' !== n)) return;
  ...
  onSortButtonClick(t) {
    ...
    if (!(o && o instanceof HTMLButtonElement && o.parentElement)) return;
    const s = o.parentElement.getAttribute('aria-sort'),
      n = Number.parseInt(
        null != (e = null == o ? void 0 : o.getAttribute('data-index'))
          ? e
          : '0',
        10
      ),
      i = 'none' === s || 'descending' === s ? 'ascending' : 'descending',
      r = this.getTableRowsArray(),
      a = this.sort(r, n, i);
    (this.addRows(a),
      this.removeButtonStates(),
      this.updateButtonState(o, i),
      this.updateDirectionIndicators());
  }
  updateCaption() {
    ...
    t ||
      ...
      t.classList.add('govuk-visually-hidden'),
      (t.textContent = ' (column headers with buttons are sortable).'),
      this.$caption.appendChild(t));
  }
  updateButtonState(t, e) {
    if ('ascending' !== e && 'descending' !== e) return;
    t.parentElement.setAttribute('aria-sort', e);
    let o = this.config.statusMessage;
    ((o = o.replace(/%heading%/, t.textContent)),
      (o = o.replace(/%direction%/, this.config[`${e}Text`])),
  ...
  removeButtonStates() {
    for (const t of this.$headings) t.setAttribute('aria-sort', 'none');
  }
  addRows(t) {
    for (const e of t) this.$body.append(e);
  }
  getTableRowsArray() {
  ...
  sort(t, e, o) {
    return t.sort((t, s) => {
      ...
      return 'number' != typeof r || 'number' != typeof a
        ? r.toString().localeCompare(a.toString())
        : r - a;
    });
  }
  getCellValue(t) {
    const e = t.getAttribute('data-sort-value') || t.innerHTML,
      o = Number(e);
