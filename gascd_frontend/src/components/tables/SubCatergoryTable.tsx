...
const SubCatergoryTable: React.FC<DataTableProps> = ({
  ...
  const comparatorLabel = (
    columnHeaders as { ComparatorLabel?: string | null }
  ).ComparatorLabel;
          ...
          <thead className="govuk-table__head">
            <tr className="govuk-table__row">
              ...
              {[
                ...
                'LALabel',
                ...(showComparatorAverage ? ['ComparatorLabel'] : []),
                'RegionLabel',
                'CountryLabel',
              ]
                .filter(
            ...
            {Object.entries(rowHeaders).map(([key, value]) => (
              ...
              >
                {totalsRows?.includes(key) ? (
                  <th
                    scope="row"
                    className="govuk-table__cell govuk-!-font-weight-bold scrollable-table__header"
                  >
                    {totalsRows?.includes(key) && totalsRows[0] !== key && (
                      <br />
                    )}
