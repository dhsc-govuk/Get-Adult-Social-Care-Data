DROP TABLE IF EXISTS bedcount_per_hundred_thousand_18_64;
DROP TABLE IF EXISTS bedcount_per_hundred_thousand_65over;
DROP TABLE IF EXISTS num_clients_long_term_support_per100k_adults;
DROP TABLE IF EXISTS expenditure_duration_psr_per100k_adults;
DROP TABLE IF EXISTS expenditure_longterm_support_setting_per100k_adults;
DROP TABLE IF EXISTS num_clients_comm_care_per100k_adults;
...
DROP TABLE IF EXISTS expenditure_duration_psr;
DROP TABLE IF EXISTS expenditure_longterm_support_setting;
DROP TABLE IF EXISTS num_clients_comm_care;
DROP TABLE IF EXISTS num_provider_locations;
...
DROP TABLE IF EXISTS local_authority_peers;
...
CREATE TABLE geo_data (
                          ...
                          bounding_polygon geography (polygon),
                          loaded_datetime timestamp with time zone NOT NULL,
...
CREATE TABLE pansi (
                       ...
                       time_series numeric[] NOT NULL,
                       latest_value numeric,
                       CONSTRAINT "PK_pansi" PRIMARY KEY (id),
                       CONSTRAINT "FK_pansi_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);
...
CREATE TABLE expenditure_duration_psr (
                                          id integer GENERATED BY DEFAULT AS IDENTITY,
                                          loaded_datetime timestamp with time zone NOT NULL,
                                          start_date date NOT NULL,
                                          end_date date NOT NULL,
                                          ...
                                          time_series numeric[] NOT NULL,
                                          latest_value numeric,
                                          CONSTRAINT "PK_expenditure_duration_psr" PRIMARY KEY (id),
                                          CONSTRAINT "FK_expenditure_duration_psr_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE expenditure_longterm_support_setting (
                                                      id integer GENERATED BY DEFAULT AS IDENTITY,
                                                      loaded_datetime timestamp with time zone NOT NULL,
                                                      start_date date NOT NULL,
                                                      end_date date NOT NULL,
                                                      ...
                                                      time_series numeric[] NOT NULL,
                                                      latest_value numeric,
                                                      CONSTRAINT "PK_expenditure_longterm_support_setting" PRIMARY KEY (id),
                                                      CONSTRAINT "FK_expenditure_longterm_support_setting_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE num_clients_comm_care (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_num_clients_comm_care" PRIMARY KEY (id),
                                       CONSTRAINT "FK_num_clients_comm_care_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE num_provider_locations (
                                        id integer GENERATED BY DEFAULT AS IDENTITY,
                                        loaded_datetime timestamp with time zone NOT NULL,
                                        start_date date NOT NULL,
                                        end_date date NOT NULL,
                                        ...
                                        time_series numeric[] NOT NULL,
                                        latest_value numeric,
                                        CONSTRAINT "PK_num_provider_locations" PRIMARY KEY (id),
                                        CONSTRAINT "FK_num_provider_locations_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE bedcount_per_hundred_thousand_18_64 (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_bedcount_per_hundred_thousand_18_64" PRIMARY KEY (id),
                                       CONSTRAINT "FK_bedcount_per_hundred_thousand_18_64_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE bedcount_per_hundred_thousand_65over (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_bedcount_per_hundred_thousand_65over" PRIMARY KEY (id),
                                       CONSTRAINT "FK_bedcount_per_hundred_thousand_65over_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE num_clients_long_term_support_per100k_adults (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_num_clients_long_term_support_per100k_adults" PRIMARY KEY (id),
                                       CONSTRAINT "FK_num_clients_long_term_support_per100k_adults_metrics_metric~" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE expenditure_duration_psr_per100k_adults (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_expenditure_duration_psr_per100k_adults" PRIMARY KEY (id),
                                       CONSTRAINT "FK_expenditure_duration_psr_per100k_adults_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE expenditure_longterm_support_setting_per100k_adults (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_expenditure_longterm_support_setting_per100k_adults" PRIMARY KEY (id),
                                       CONSTRAINT "FK_expenditure_longterm_support_setting_per100k_adults_metrics~" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);

CREATE TABLE num_clients_comm_care_per100k_adults (
                                       id integer GENERATED BY DEFAULT AS IDENTITY,
                                       loaded_datetime timestamp with time zone NOT NULL,
                                       start_date date NOT NULL,
                                       end_date date NOT NULL,
                                       ...
                                       time_series numeric[] NOT NULL,
                                       latest_value numeric,
                                       CONSTRAINT "PK_num_clients_comm_care_per100k_adults" PRIMARY KEY (id),
                                       CONSTRAINT "FK_num_clients_comm_care_per100k_adults_metrics_metric_fk" FOREIGN KEY (metric_fk) REFERENCES metrics (id) ON DELETE CASCADE
);
...
CREATE TABLE local_authority_peers (
                            id integer GENERATED BY DEFAULT AS IDENTITY,
                            local_authority_fk integer NOT NULL,
                            peer_rank integer NOT NULL,
                            peer_local_authority_fk integer NOT NULL,
                            loaded_datetime timestamp with time zone NOT NULL,
                            CONSTRAINT "PK_local_authority_peers" PRIMARY KEY (id),
                            CONSTRAINT "FK_local_authority_peers_local_authorities_local_authority_fk" FOREIGN KEY (local_authority_fk) REFERENCES local_authorities (id) ON DELETE CASCADE,
                            CONSTRAINT "FK_local_authority_peers_local_authorities_peer_local_authorit~" FOREIGN KEY (peer_local_authority_fk) REFERENCES local_authorities (id) ON DELETE CASCADE
);
...
CREATE INDEX "IX_pansi_metric_fk" ON pansi (metric_fk);
...
CREATE INDEX "IX_pansi_location_code_location_type" ON pansi (location_code, location_type);
...
CREATE INDEX "IX_expenditure_duration_psr_location_code_location_type" ON expenditure_duration_psr (location_code, location_type);

CREATE INDEX "IX_expenditure_duration_psr_metric_fk" ON expenditure_duration_psr (metric_fk);

CREATE INDEX "IX_expenditure_longterm_support_setting_location_code_location~" ON expenditure_longterm_support_setting (location_code, location_type);

CREATE INDEX "IX_expenditure_longterm_support_setting_metric_fk" ON expenditure_longterm_support_setting (metric_fk);

CREATE INDEX "IX_num_clients_comm_care_location_code_location_type" ON num_clients_comm_care (location_code, location_type);

CREATE INDEX "IX_num_clients_comm_care_metric_fk" ON num_clients_comm_care (metric_fk);
CREATE INDEX "IX_bedcount_per_hundred_thousand_18_64_location_code_location_~" ON bedcount_per_hundred_thousand_18_64 (location_code, location_type);
CREATE INDEX "IX_bedcount_per_hundred_thousand_18_64_metric_fk" ON bedcount_per_hundred_thousand_18_64 (metric_fk);
CREATE INDEX "IX_bedcount_per_hundred_thousand_65over_location_code_location~" ON bedcount_per_hundred_thousand_65over (location_code, location_type);
CREATE INDEX "IX_bedcount_per_hundred_thousand_65over_metric_fk" ON bedcount_per_hundred_thousand_65over (metric_fk);
CREATE INDEX "IX_num_clients_long_term_support_per100k_adults_location_code_~" ON num_clients_long_term_support_per100k_adults (location_code, location_type);
CREATE INDEX "IX_num_clients_long_term_support_per100k_adults_metric_fk" ON num_clients_long_term_support_per100k_adults (metric_fk);
CREATE INDEX "IX_expenditure_duration_psr_per100k_adults_location_code_locat~" ON expenditure_duration_psr_per100k_adults (location_code, location_type);
CREATE INDEX "IX_expenditure_duration_psr_per100k_adults_metric_fk" ON expenditure_duration_psr_per100k_adults (metric_fk);
CREATE INDEX "IX_expenditure_longterm_support_setting_per100k_adults_locatio~" ON expenditure_longterm_support_setting_per100k_adults (location_code, location_type);
CREATE INDEX "IX_expenditure_longterm_support_setting_per100k_adults_metric_~" ON expenditure_longterm_support_setting_per100k_adults (metric_fk);
CREATE INDEX "IX_num_clients_comm_care_per100k_adults_location_code_location~" ON num_clients_comm_care_per100k_adults (location_code, location_type);
CREATE INDEX "IX_num_clients_comm_care_per100k_adults_metric_fk" ON num_clients_comm_care_per100k_adults (metric_fk);

CREATE INDEX "IX_num_provider_locations_location_code_location_type" ON num_provider_locations (location_code, location_type);

CREATE INDEX "IX_num_provider_locations_metric_fk" ON num_provider_locations (metric_fk);

CREATE INDEX "IX_local_authority_peers_local_authority_fk" ON local_authority_peers (local_authority_fk);

CREATE INDEX "IX_local_authority_peers_peer_local_authority_fk" ON local_authority_peers (peer_local_authority_fk);
...
DECLARE
    ...
    bedcount_per_hundred_thousand_18_64_metric_group_id integer = 221;
    bedcount_per_hundred_thousand_65over_metric_group_id integer = 222;
    num_clients_long_term_support_per100k_adults_metric_group_id integer = 223;
    expenditure_duration_psr_per100k_adults_metric_group_id integer = 224;
    expenditure_longterm_support_setting_per100k_adults_metric_group_id integer = 225;
    num_clients_comm_care_per100k_adults_metric_group_id integer = 226;              
    ...
    bedcount_per_hundred_thousand_18_64_metric_id integer = 131;
    bedcount_per_hundred_thousand_65over_metric_id integer = 132;
    num_clients_long_term_support_per100k_adults_metric_id integer = 133;
    expenditure_duration_psr_per100k_adults_metric_id integer = 134;
    expenditure_longterm_support_setting_per100k_adults_metric_id integer = 135;
    num_clients_comm_care_per100k_adults_metric_id integer = 136;
...
BEGIN
    ...
    VALUES
           ...
           (2, 1, 2, 3, CURRENT_TIMESTAMP),
           (3, 1, 3, 4, CURRENT_TIMESTAMP),
           (4, 1, 4, 5, CURRENT_TIMESTAMP),
           (5, 2, 1, 1, CURRENT_TIMESTAMP),
           (6, 2, 2, 3, CURRENT_TIMESTAMP),
           (7, 2, 3, 4, CURRENT_TIMESTAMP),
           (8, 2, 4, 5, CURRENT_TIMESTAMP),
           (9, 3, 1, 1, CURRENT_TIMESTAMP),
           (10, 3, 2, 2, CURRENT_TIMESTAMP),
           (11, 3, 3, 4, CURRENT_TIMESTAMP),
           (12, 3, 4, 5, CURRENT_TIMESTAMP),
           (13, 4, 1, 1, CURRENT_TIMESTAMP),
           (14, 4, 2, 2, CURRENT_TIMESTAMP),
           (15, 4, 3, 3, CURRENT_TIMESTAMP),
           (16, 4, 4, 5, CURRENT_TIMESTAMP),
           (17, 5, 1, 1, CURRENT_TIMESTAMP),
           (18, 5, 2, 2, CURRENT_TIMESTAMP),
           (19, 5, 3, 3, CURRENT_TIMESTAMP),
           (20, 5, 4, 4, CURRENT_TIMESTAMP);
    ...
    VALUES (metric_group_id, 'metric_group_code', CURRENT_TIMESTAMP, 'Metric group display name' ),
           ...
           (bedcount_per_hundred_thousand_18_64_metric_group_id, 'bedcount_per_hundred_thousand_18_64', CURRENT_TIMESTAMP, 'metric group display name' ),
           (bedcount_per_hundred_thousand_65over_metric_group_id, 'bedcount_per_hundred_thousand_65over', CURRENT_TIMESTAMP, 'metric group display name' ),
           (num_clients_long_term_support_per100k_adults_metric_group_id, 'num_clients_long_term_support_per100k_adults', CURRENT_TIMESTAMP, 'metric group display name' ),
           (expenditure_duration_psr_per100k_adults_metric_group_id, 'expenditure_duration_psr_per100k_adults', CURRENT_TIMESTAMP, 'metric group display name' ),
           (expenditure_longterm_support_setting_per100k_adults_metric_group_id, 'expenditure_longterm_support_setting_per100k_adults', CURRENT_TIMESTAMP, 'metric group display name' ),
           (num_clients_comm_care_per100k_adults_metric_group_id, 'num_clients_comm_care_per100k_adults', CURRENT_TIMESTAMP, 'metric group display name' );
    ...
    VALUES (metric_id, 'metric_code', metric_group_id, 'Metric filter info', 'This is a numerator 2', 'This is a denominator 2', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP), 
           ...
           (bedcount_per_hundred_thousand_18_64_metric_id, 'bedcount_per_hundred_thousand_18_64_total', bedcount_per_hundred_thousand_18_64_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bedcount_per_hundred_thousand_65over_metric_id, 'bedcount_per_hundred_thousand_65over_total', bedcount_per_hundred_thousand_65over_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (num_clients_long_term_support_per100k_adults_metric_id, 'access_and_mobility_only_physical_support_18_and_over_per100k_adults', num_clients_long_term_support_per100k_adults_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (expenditure_duration_psr_per100k_adults_metric_id, 'edpsr_lt_learning_disability_support_all_ages_per100k_adults', expenditure_duration_psr_per100k_adults_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (expenditure_longterm_support_setting_per100k_adults_metric_id, 'elss_supported_accommodation_all_ages_per100k_adults', expenditure_longterm_support_setting_per100k_adults_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (num_clients_comm_care_per100k_adults_metric_id, 'nccc_num_clients_comm_care_per100k_adults', num_clients_comm_care_per100k_adults_metric_group_id, 'Metric filter info', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP);
    ...
    VALUES (1, perc_household_ownership_total_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 6.23], 6.23, CURRENT_TIMESTAMP),
           (2, perc_household_ownership_total_metric_id, 'E08000014', 'LA', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [15.2,25.3,35.4,45.5,55.6], 55.6, CURRENT_TIMESTAMP),
    ...
    VALUES (8, perc_households_deprivation_deprived_total_metric_id, 'E92000002', 'National', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [99.9], 99.9, CURRENT_TIMESTAMP),
           ...
           (4, perc_households_deprivation_deprived_total_metric_id, 'E08000016', 'LA', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [13.1,23.2,33.3,43.4,53.5], 53.5, CURRENT_TIMESTAMP),
           (5, perc_households_deprivation_deprived_total_metric_id, 'E08000017', 'LA', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [14.1,24.2,34.3,44.4,54.5], 54.5, CURRENT_TIMESTAMP),
           (6, perc_households_deprivation_deprived_total_metric_id, 'E08000018', 'LA', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [15.1,25.2,35.3,45.4,55.5], 55.5, CURRENT_TIMESTAMP);
    ...
    VALUES (1, perc_households_one_person_total_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 6.25], 6.25, CURRENT_TIMESTAMP),
           (2, perc_households_one_person_total_metric_id, 'E92000001', 'National', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [18.5], 18.5, CURRENT_TIMESTAMP),
           (3, perc_households_one_person_total_metric_id, 'E08000014', 'LA', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [20.1], 20.1, CURRENT_TIMESTAMP),
           (4, perc_households_one_person_total_metric_id, 'E08000015', 'LA', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [19.3], 19.3, CURRENT_TIMESTAMP),
           (5, perc_households_one_person_total_metric_id, 'E08000016', 'LA', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [21.4], 21.4, CURRENT_TIMESTAMP),
           (6, perc_households_one_person_total_metric_id, 'E08000017', 'LA', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [17.8], 17.8, CURRENT_TIMESTAMP),
           (7, perc_households_one_person_total_metric_id, 'E08000018', 'LA', '2021-03-01 00:00:00', '2021-03-21 00:00:00', ARRAY [22.2], 22.2, CURRENT_TIMESTAMP);
    ...
    INSERT INTO bedcount_per_hundred_thousand_18_64 (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, bedcount_per_hundred_thousand_18_64_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.1], 8.1, CURRENT_TIMESTAMP);

    INSERT INTO bedcount_per_hundred_thousand_65over (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, bedcount_per_hundred_thousand_65over_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.2], 8.2, CURRENT_TIMESTAMP);

    INSERT INTO num_clients_long_term_support_per100k_adults (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, num_clients_long_term_support_per100k_adults_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.3], 8.3, CURRENT_TIMESTAMP);

    INSERT INTO expenditure_duration_psr_per100k_adults (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, expenditure_duration_psr_per100k_adults_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.4], 8.4, CURRENT_TIMESTAMP);

    INSERT INTO expenditure_longterm_support_setting_per100k_adults (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, expenditure_longterm_support_setting_per100k_adults_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.5], 8.5, CURRENT_TIMESTAMP);

    INSERT INTO num_clients_comm_care_per100k_adults (id, metric_fk, location_code, location_type, start_date, end_date, time_series, latest_value, loaded_datetime)
    VALUES (1, num_clients_comm_care_per100k_adults_metric_id, 'E92000001', 'Regional', '2001-01-01 00:00:00', '2026-01-01 00:00:00', ARRAY [2.2,3.3,4.4,5.5, 8.6], 8.6, CURRENT_TIMESTAMP);
