...
DECLARE
    ...
    gd_la integer = 3;
BEGIN
    INSERT INTO geo_data(id, code, coordinate, bounding_box, loaded_datetime)
    ...
    INSERT INTO postcodes (id, code, display_postcode, coordinate, local_authority_fk, loaded_datetime)
    VALUES (1, 'KT220UF', 'KT22 0UF', ST_Point(-0.349629386, 51.33954856349381), la_id, CURRENT_TIMESTAMP),
