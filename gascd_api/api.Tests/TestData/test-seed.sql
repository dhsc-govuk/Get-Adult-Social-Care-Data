...
INSERT INTO metric_groups (id, code, loaded_datetime)
    VALUES (metric_group_id, 'metric_group_code', CURRENT_TIMESTAMP ),
           ...
           (bedcount_metric_group_id, 'bedcount', CURRENT_TIMESTAMP),
           (bphta_metric_group_id, 'bedcount_per_hundred_thousand_adults',  CURRENT_TIMESTAMP),
           (dementia_estimated_diagnosis_rate_65over_metric_group_id, 'dementia_estimated_diagnosis_rate_65over',  CURRENT_TIMESTAMP),
           (dementia_prevalence_65over_metric_group_id, 'dementia_prevalence_65over', CURRENT_TIMESTAMP),
           (dementia_qof_prevalence_metric_group_id, 'dementia_qof_prevalence', CURRENT_TIMESTAMP),
           (dementia_register_65over_per100k_metric_group_id, 'dementia_register_65over_per100k',  CURRENT_TIMESTAMP),
           (learning_disability_prevalence_metric_group_id, 'learning_disability_prevalence', CURRENT_TIMESTAMP),
           (median_bed_count_metric_group_id, 'median_bed_count',  CURRENT_TIMESTAMP),
           (median_occupancy_metric_group_id, 'median_occupancy',  CURRENT_TIMESTAMP),
           (occupancy_rates_metric_group_id, 'occupancy_rates',  CURRENT_TIMESTAMP),
           (perc_18_64_metric_group_id, 'perc_18_64',  CURRENT_TIMESTAMP),
           (perc_65over_metric_group_id, 'perc_65over',  CURRENT_TIMESTAMP),
           (perc_75over_metric_group_id, 'perc_75over',  CURRENT_TIMESTAMP),
           (perc_85over_metric_group_id, 'perc_85over',  CURRENT_TIMESTAMP),
           (perc_general_health_metric_group_id, 'perc_general_health',  CURRENT_TIMESTAMP),
           (perc_household_ownership_metric_group_id, 'perc_household_ownership',  CURRENT_TIMESTAMP),
           (perc_households_deprivation_deprived_metric_group_id, 'perc_households_deprivation_deprived',  CURRENT_TIMESTAMP),
           (perc_households_one_person_metric_group_id, 'perc_households_one_person',  CURRENT_TIMESTAMP),
           (perc_population_disability_metric_group_id, 'perc_population_disability',  CURRENT_TIMESTAMP),
    ...
    VALUES (metric_id, 'metric_code', metric_group_id, 'Metric', 'This is a numerator 2', 'This is a denominator 2', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP), 
           ...
           (bphta_total_general_residential_metric_id, 'bedcount_per_hundred_thousand_adults_general_residential', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_learning_disability_nursing_metric_id, 'bedcount_per_hundred_thousand_adults_learning_disability_nursing', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_learning_disability_residential_metric_id, 'bedcount_per_hundred_thousand_adults_learning_disability_residential', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_mental_health_nursing_metric_id, 'bedcount_per_hundred_thousand_adults_mental_health_nursing', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_mental_health_residential_metric_id, 'bedcount_per_hundred_thousand_adults_mental_health_residential', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_transitional_metric_id, 'bedcount_per_hundred_thousand_adults_transitional', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (bphta_total_ypd_young_physically_disabled_metric_id, 'bedcount_per_hundred_thousand_adults_ypd_young_physically_disabled', bphta_metric_group_id, 'Bedcount', 'This is a numerator', 'This is a denominator', 'ONS', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           ...
           (dementia_register_65over_per100k_metric_id, 'dementia_register_65over_per100k', dementia_register_65over_per100k_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (learning_disability_prevalence_metric_id, 'learning_disability_prevalence', learning_disability_prevalence_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (median_bed_count_total_metric_id, 'median_bed_count_total', median_bed_count_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (median_occupancy_total_metric_id, 'median_occupancy_total', median_occupancy_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (occupancy_rates_total_metric_id, 'occupancy_rate_total', occupancy_rates_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_18_64_metric_id, 'perc_18_64', perc_18_64_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_65over_metric_id, 'perc_65over', perc_65over_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_75over_metric_id, 'perc_75over', perc_75over_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_85over_metric_id, 'perc_85over', perc_85over_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_general_health_total_metric_id, 'perc_general_health', perc_general_health_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_household_ownership_total_metric_id, 'perc_household_ownership', perc_household_ownership_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_households_deprivation_deprived_total_metric_id, 'perc_households_deprivation_deprived', perc_households_deprivation_deprived_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_households_one_person_total_metric_id, 'perc_households_one_person', perc_households_one_person_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_population_disability_disabled_total_metric_id, 'perc_population_disability', perc_population_disability_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
           (perc_unpaid_care_provider_total_metric_id, 'perc_unpaid_care_provider', perc_unpaid_care_provider_metric_group_id, 'Median Bed Count', 'This is a numerator', 'This is a denominator', 'Capacity Tracker', 'numbers', 'Daily', CURRENT_TIMESTAMP),
